     ...
     <View style={{ flex: 1 }}>
      <View style={{ flex: 0.1 }}>
        ...
        <View style={styles.absentContainer}>
          ...
          <Text style={styles.presentText}>Present: {this.state.present_students.length}</Text>
          <Text style={styles.absentText}>Absent: {this.state.absent_students.length}</Text>
        </View>
      </View>
    );
  }
